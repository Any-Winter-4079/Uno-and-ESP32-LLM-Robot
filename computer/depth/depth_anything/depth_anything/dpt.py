...
from bootstrap import resolve_dinov2_path

#################
# Description   #
#################
# This is a slightly modified version of the Depth Anything dpt.py to adapt it to the way we run it on this project.
...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vitl', features=256, out_channels=[256, 512, 1024, 1024], use_bn=False, use_clstoken=False, localhub=True):
        ...
        if localhub:
            local_path = resolve_dinov2_path()
